      ...
      <div className="p-20 rounded-xl grid grid-cols-1 md:grid-cols-2 gap-5 bg-gradient-to-br from-slate-950 via-slate-800 to-emerald-950">
        <div>
          ...
          <div className="mt-5 flex gap-5  text-white">
            {" "}
            <h2 className="px-3 p-2 border rounded-4xl flex gap-2 items-center inline-flex">
              {" "}
              <ChartNoAxesColumnIncreasing className="text-sky-400"/> {course?.courseLayout.level}{" "}
            </h2>{" "}
            <h2 className="px-3 p-2 border rounded-4xl flex gap-2 items-center inline-flex">
              {" "}
              <BookOpen className="text-green-400" /> {course?.courseLayout.totalChapters} Chapters{" "}
            </h2>{" "}
          </div>
        </div>
